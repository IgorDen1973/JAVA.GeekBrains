...
//        System.out.println("  ");
    ...
    @Override    // ****************** добавил  ************************
//    public void getWeatherForFiveDays(String cityKey) throws IOException, ParseException {  CHANGE!!
        public List<Weather> getWeatherForFiveDays(String cityKey) throws IOException, ParseException {
...
// http://dataservice.accuweather.com/forecasts/v1/daily/5day/295212?apikey={{accuweatherApiKey}}&language=ru&metric=true
        ...
        List<Weather> weatherForFive = new ArrayList<>();
...
//            System.out.printf("At %s in %s expected temperature from %sC to %sC at day %s, at night %s\n", dayForecastDate, dayCityName, dayTemperatureMin, dayTemperatureMax,dayDescriptionDay,dayDescriptionNight);
            Weather oneFromFive = new Weather(dayForecastDate,dayCityName,dayTemperatureMin,dayTemperatureMax,dayDescriptionDay,dayDescriptionNight);
            weatherForFive.add(oneFromFive);
        }
        return weatherForFive;             // CHANGE
